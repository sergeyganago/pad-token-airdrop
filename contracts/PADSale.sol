...
contract PADSale is Pausable {
    ...
    /**
     * Constructor for a crowdsale of PADToken tokens.
     *
     ...
     * @param ratePADToEther                the conversion rate from PAD to Ether
    ...
    function PADSale(
        ...
        setRate(ratePADToEther);
        tokenReward = PADToken(addressOfTokenUsedAsReward);
    }
    ...
    function () payable whenNotPaused beforeDeadline afterStartTime saleNotClosed nonReentrant {
        ...
        // and PAD have the same number of decimal places (18)
    ...
    /**
     * The owner can update the rate (PAD to ETH).
     *
     * @param _rate  the new rate for converting PAD to ETH
     */
     ...
     * are in units of wei and mini-PAD. Every digit counts.
     *
     * @param _to            the recipient of the tokens
     * @param amountWei     the amount contributed in wei
     * @param amountMiniPAD the amount of tokens transferred in mini-PAD
     */
    function ownerAllocateTokens(address _to, uint amountWei, uint amountMiniPAD) external
            onlyOwner nonReentrant
    {
        if (!tokenReward.transferFrom(tokenReward.owner(), _to, amountMiniPAD)) {
            revert();
        }
    ...
    */
    ...
    /**
     * Given an amount in PAD, this method returns the equivalent amount
     * in mini-PAD.
     *
     * @param amount    an amount expressed in units of PAD
     */
    function convertToMiniPAD(uint amount) internal constant returns (uint) {
