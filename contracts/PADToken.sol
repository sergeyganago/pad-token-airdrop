...
/**
 * The PAD token (PAD) has a fixed supply and restricts the ability
 ...
 */
contract PADToken is StandardToken, BurnableToken, Ownable {
     ...
     */
    function PADToken(address _admin) {
     ...
     *
     * @param _value    The amount of tokens to burn in mini-PAD
     */
